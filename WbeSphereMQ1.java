...
public class WbeSphereMQ1 { 
	...
	public String  sendInfoToCRPT(String XMLDOC){
		...
		headContent.append("0000003525");//柜员代码
		headContent.append("cifquery            ");//交易类型
		headContent.append("Branch    ");//渠道代码
		headContent.append("00356981231003215630");///交易流水号
		headContent.append("MELI                ");//保险公司代码
		headContent.append("CNHSBC706009446     ");//Cifid
...
//			message.messageFlags= MQC.MQMT_REQUEST;
			...
			message.write(content.getBytes());// 将消息放入队列
...
//			messageRec.format=MQConstants.MQFMT_STRING;
			...
			System.out.println("成功接收回复的信息："); 
			String lei=messageRec.readStringOfByteLength(messageRec.getMessageLength());
